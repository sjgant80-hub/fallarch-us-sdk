...
**FallArch · sovereign single-file US architecture firm OS** — sovereign SDK extracted from `fallarch-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallarch-us-sdk
```

## Use
```js
import * as fallarch-us from '@ai-native-solutions/fallarch-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallarch-us-sdk/
- MCP wrapper: [`@ai-native-solutions/fallarch-us-mcp`](https://github.com/sjgant80-hub/fallarch-us-mcp)
- HTTP API: [`@ai-native-solutions/fallarch-us-api`](https://github.com/sjgant80-hub/fallarch-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallarch-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallarch-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallarch-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallarch-us-sdk -- npx -y @ai-native-solutions/fallarch-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallarch-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallarch-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallarch-us-sdk/
- **Source**: https://github.com/sjgant80-hub/fallarch-us-sdk
